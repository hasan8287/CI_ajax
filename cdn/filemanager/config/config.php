...
//    |   |   |   |   |- plugin.min.js
$base_url = 'http://localhost/solid';  // base url (only domain) of site (without final /). If you prefer relative urls leave empty
$upload_dir = './cdn/uploads/'; // path from base_url to base of upload folder (with start and final /)
