...
<div class="container-fluid" style="margin:0px;padding: 0px;">
 <div id="myCarousel" class="carousel slide" data-ride="carousel" >
    ...
    <?php 
    $i=0;
    foreach ($album->result_array()  AS $data_slide) {
      if ($i==0) {
        ?>
    ...
    foreach ($album->result_array()  AS $data_slide) {
      ...
      <?php }else{
        ?>
        <div class="item">
          <img src="<?php echo base_url() ?>cdn/uploads/<?php echo $data_slide['foto']; ?>" alt="<?php echo $data_slide['judul_foto']; ?>"
           style="max-height: 350px;">
          <div class="carousel-caption">
            <h3><?php echo $data_slide['judul_foto']; ?></h3>
          </div>
        </div>
        <?php
      }
