...
<body>
	<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation" onload="aa()">
		<div class="container-fluid">
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#"><span>SOLID</span>Admin</a>
				<ul class="user-menu">
	...
	<div id="sidebar-collapse" class="col-sm-3 col-lg-2 sidebar">
		...
		<ul class="nav menu">
			...
			<li><a href="<?php echo base_url() ?>admin/data_user">
			 User</a></li>

			 <li><a href="<?php echo base_url() ?>admin/foto">
			 Foto</a></li>

			 <li><a href="<?php echo base_url() ?>admin/data_album">
			 Album</a></li>
